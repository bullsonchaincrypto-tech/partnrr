...
// Intelligent sökning
export const searchInfluencers = (company_profile_id, platforms, filters) => request('/search/influencers', { method: 'POST', body: JSON.stringify({ company_profile_id, platforms, filters }) });
